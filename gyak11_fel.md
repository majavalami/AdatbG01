...
```js
INSERT INTO szemely (nev, szulev, foglalkozas) VALUES ('Kis Bela', 2000, 'lakatos');
...
select * from szemely;
//claster key alapján rendez sorba
```
...
desc szemely; //megmutatja az indexet is
```
...
where nev = 'Kiss Bela' AND szulev = 2000 AND foglalkozas = 'lakatos'; //meg kell adni az összes kulcsmezőt
