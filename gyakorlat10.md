...
```js
lpush //balról tölti fel
rpush //jobbról tölti fel

RPUSH tantargyak "programozas alapjai" matematika adatbaziskezekes //"" - ha van benne szóköz
...
ZRANGE szemelye 0 -1 //listázó parancs, start és stop index 
```
...
```js
KEYS *a* //rettentően energiaigényes csak akkor szabad kiadni ha kevés a kulcs

SCAN 0 MATCH *a* COUNT 200//nem fogja meg az adatbázist külön fut
```
